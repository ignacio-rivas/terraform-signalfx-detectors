# AWS-EC2-instance SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-aws-ec2-instance" {
  source = "github.com/claranet/detectors/signalfx//modules/integration_aws-ec2-instance?ref={revision}"
...
|---|---|---|---|---|---|
|AWS EC2 CPU heartbeat|X|-|-|-|-|
|AWS EC2 CPU cpu utilization|X|X|-|-|-|
